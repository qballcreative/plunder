...
import { Player, GoodsType } from '@/types/game';
...
export const PlayerHand = ({ player, isCurrentPlayer, isOpponent = false }: PlayerHandProps) => {
          ...
          {player.hand.map((card, index) => (
            ...
            >
              <GameCard
                ...
                disabled={!isCurrentPlayer || isOpponent || phase !== 'playing'}
                faceDown={isOpponent}
                size="md"
              />
            </motion.div>
